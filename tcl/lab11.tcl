...
\
  ...
  set simple_fifo_0 [ create_bd_cell -type ip -vlnv NAVY.MIL:user:simple_fifo:1.0 simple_fifo_0 ]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins simple_fifo_0/S_AXIS_WRITE]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_broadcaster_0_M00_AXIS] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net dds_compiler_0_M_AXIS_DATA [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins lowlevel_dac_intfc_0/data_in]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins simple_fifo_0/S_AXI_READ] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M01_AXI] [get_bd_intf_pins simple_fifo_0/S_AXI_READ] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
  ...
  [get_bd_pins simple_fifo_0/s00_axi_aclk]
  ...
  [get_bd_pins simple_fifo_0/s00_axi_aresetn]
  ...
  [get_bd_pins simple_fifo_0/s00_axis_aclk]
  ...
  [get_bd_pins simple_fifo_0/s00_axis_aresetn]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs simple_fifo_0/S00_AXI/S00_AXI_reg] -force
